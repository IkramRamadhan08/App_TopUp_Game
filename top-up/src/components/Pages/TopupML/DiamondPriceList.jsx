...
const DiamonPriceList = () => {
  ...
  useEffect(() => {
    async function fetchProducts() {
      try {
        const response = await axios.get("http://localhost:8000/api/products?type=mobilelegend");
...
// };
  ...
  payment_method: metodePembayaran, // pastikan ini diisi dari pilihan user
  nohp: nohp
};
